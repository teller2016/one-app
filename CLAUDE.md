...
│       ├── prs/                 #  PR 대시보드 (Gitea)
│       │   ├── ipc.ts
│       │   ├── gitea.ts         #    전역 PR 검색 + 리뷰 승인 수 보강
│       │   └── poller.ts        #    5분 주기 새 PR 알림 (첫 조회는 기준선)
│       └── tray/                #  메뉴바 트레이
