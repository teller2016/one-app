...
- ⚠️ **PTY resize 는 디바운스(120ms) + 최대 대기 상한(250ms)** 을 함께 쓴다 — 상한을 지우면 긴 드래그 동안 SIGWINCH 가 한 번도 안 나가고, xterm 은 이미 커진 채라 대체 화면(claude)이 빈칸으로 남아 **드래그 내내 검은 화면**이 된다(2026-08-20). 디바운스를 없애는 것도 금지 — 원래 폭주 방어다.
